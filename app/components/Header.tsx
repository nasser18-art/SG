...
export default function Header({ username, handleLogout }: HeaderProps) {
  ...
  return (
    <header className="bg-white border-b border-gray-200 shadow-sm">
      <div className="bg-gradient-to-r from-emerald-600 via-emerald-500 to-emerald-700 h-1"></div>

      <div className="container mx-auto px-4 py-4 max-w-7xl flex justify-between items-center">
        {/* Logo et branding */}
        <div className="flex items-center gap-4">
          <img src="/bnp-Logo.png" alt="BNP Paribas" className="h-10 object-contain" />
        ...
        <nav className="hidden lg:flex items-center gap-8">
          <a href="#" className="text-sm text-gray-700 hover:text-emerald-600 transition font-medium">
            Accueil
          </a>
          <a href="#" className="text-sm text-gray-700 hover:text-emerald-600 transition font-medium">
            Comptes
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-2 bg-emerald-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-emerald-700 transition shadow-md hover:shadow-lg"
          >
            <LogOut size={16} />
            Déconnexion
          </button>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden mt-4 pt-4 border-t border-gray-200 space-y-3 px-4 pb-4">
          <a href="#" className="block text-sm text-gray-700 hover:text-emerald-600 font-medium py-2">
            Accueil
          </a>
          <a href="#" className="block text-sm text-gray-700 hover:text-emerald-600 font-medium py-2">
            Comptes
          ...
          <div className="pt-3 border-t border-gray-200">
            ...
            <button
              onClick={handleLogout}
              className="w-full bg-emerald-600 text-white py-2 rounded-lg text-sm font-semibold hover:bg-emerald-700 transition flex items-center justify-center gap-2"
            >
              <LogOut size={16} />
              Déconnexion
            </button>
